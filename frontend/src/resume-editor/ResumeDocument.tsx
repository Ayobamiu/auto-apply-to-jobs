        ...
        <header className="text-center">
          ...
          <div className="mt-1.5 text-left">
            ...
            {getStr(basics, "summary") ? (
              <div className="mt-0.5 text-sm">{getStr(basics, "summary")}</div>
            ) : null}
          </div>
        </header>
        {work.length > 0 && (
              ...
              <div key={i} className={compact ? "mb-2" : "mb-3"}>
                <p className="text-sm">
                  <DisplayText
                    ...
                    className="text-gray-700"
                  />
                  {getStr(entry, "position") && getStr(entry, "organization")
                    ? sepP()
                    : null}
                  <DisplayText
                ...
                {getArr<string>(entry, "highlights").filter(Boolean).length >
                  0 && (
        ...
        {languages.length > 0 && (
          <section>
            ...
            {languages.map((entry, i) => (
              <div key={i} className={`${compact ? "mb-1.5" : "mb-3"} text-sm`}>
        ...
        {certificates.length > 0 && (
          <section>
            ...
            {certificates.map((entry, i) => (
              <div key={i} className={`text-sm ${compact ? "mb-1.5" : "mb-3"}`}>
                <DisplayText
                  value={getStr(entry, "name")}
                  className="font-semibold"
                />
    ...
    >
            ...
            <div key={i} className="mb-3">
              ...
              <div className="flex flex-wrap gap-1.5 mt-0.5">
                ...
                <button
                  type="button"
                  className={addBtn}
                  onClick={() => addHighlight(`skills.${i}.keywords`, keywords)}
                >
                  + keyword
                </button>
              </div>
      ...
      <section>
        ...
        {interests.map((entry, i) => {
          ...
          const onInterestKeywordsCommit = (path: string, value: string) => {
            const next = value
              .split(",")
              .map((s) => s.trim())
              .filter(Boolean);
            onChange(setResumePath(resume, `interests.${i}.keywords`, next));
          };
          if (compact) {
            return (
              <div
            ...
            <div key={i} className="mb-3">
              ...
              <div className="flex flex-wrap gap-1.5 mt-0.5">
                ...
                <button
                  type="button"
                  className={addBtn}
                  onClick={() => addHighlight(`interests.${i}.keywords`, kw)}
                >
                  + keyword
                </button>
              </div>
